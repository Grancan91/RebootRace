...
const rivalCar1 = new Cars(3, 200, -200, 80, 1, 80, 165, 2)

const rivalCar2 = new Cars(3, 350, -500, 80, 1, 80, 165, 3)

const rivalCar3 = new Cars(3, 500, -300, 80, 1, 80, 165, 3)

const rivalCar4 = new Cars(3, 650, -150, 80, 1, 80, 165, 3)

const rivalCar5 = new Cars(3, 800, -800, 80, 1, 80, 165, 3)

const arrCar = [rivalCar, rivalCar1, rivalCar2, rivalCar3, rivalCar4, rivalCar5]

// Recive a ObjPlayer with the new posX -> Inject in DOM
Player.prototype.newPos = function (player) {
  const playerCar = document.querySelector('.player1')
...
let rivalIntervalID
const screen = document.querySelector('.screen_game_mid')

const speed = 100 // Rival's speed
